...
(function (root) {
  ...
  function validate(data) {
    ...
    for(const [index,board] of data.boards.entries()){
      ...
      if(!board.loreDigest||typeof board.loreDigest!=='object')board.loreDigest={text:'',updatedAt:0};
      else board.loreDigest={text:String(board.loreDigest.text||''),updatedAt:Number(board.loreDigest.updatedAt)||0};
